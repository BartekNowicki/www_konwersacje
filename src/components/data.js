const data = {
    ...
    text83: 'gwarancja małej grupy max 5 osób lub zajęcia indywidualne',
    text84: 'z każdego spotkania wyniesiesz nową dawkę wiedzy oraz zestaw fraz  do przećwiczenia i zapamiętania',
    text9: 'o mnie',
