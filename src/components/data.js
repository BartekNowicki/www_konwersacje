...
const data = {
    ...
    textSection2_1a: 'metoda i założenia teoretyczne',
    textSection2_2a: 'The Lexical Approach',
    textSection2_3a: 'lexical approach and contextual learning',
    textSection2_4a: 'No Polglish',
    text82b: 'przy szczególnej uwadze poświęconej eliminacji tzw. Polglish czyli interferencji języka polskiego podczas uczenia się i posługiwania się językiem obcym. Przykładem Polglish może być dość powszechny wśród Polaków zwrot "so, how to say this?" zamiast "so, how do you say it?" ',
    textSection2_5a: 'Growth Oriented',
    text83b: 'Growth Oriented explanation z każdego spotkania wyniesiesz nową dawkę wiedzy oraz zestaw fraz  do przećwiczenia i zapamiętania',
    textSection2_5a: 'discussion first',
    textSection2_6a: 'discussion explanation',
    textSection2_7a: 'IT assisted',
    text85b: 'nauka wspomagana progamistycznie (gry, baza danych fraz, konto ucznia, możliwość sprawdzania wiedzy poprzez testy online)',
    textSection2_8a: 'max 5',
