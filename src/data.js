...
const data = {
    ...
    textSection2_2d: 'Przykładem Polglish może być dość powszechny wśród Polaków zwrot \'so, how to say this?\' zamiast właściwego \' so, how do you say it?\', lub też mówienie \'cooking soup\' zamiast bardziej naturalnego w języku angielskim \'making soup\'.',
    textSection2_2e: 'W czasie zajęć staramy się wyłapać te polglishowe zwroty, odnotowujemy je i staramy się wyeliminować jako dość nieładny sposób zniekształcania właściwego, naturalnego języka angielskiego.',
    textSection2_2f: 'Chętnych odsyłam do zapoznania się z zamieszczoną obok książką pióra amerykańskiego profesora mieszkającego w Polsce od ponad dwudziestu lat, który tego typu zwrotu zebrał i opisał w bardzo przystępny sposób.',
    ...
    textSection2_4c: 'Ponieważ język używany w mowie różni się znacznie od języka pisanego, skupiamy się w szczególności na tym pierwszym. Temu właśnie mają służyć konwersacje, w odróżnieniu od klasycznych metod podręcznikowych. Dlatego nie piszemy wypracowań, nie rozwiązujemy testów gramatycznych. Rozwijamy przede wszystkim umiejętność wytwarzania mowy, nie biernego rozumienia trudnych tekstów pełnych rzadkich wyrazów żyjących głównie w słownikach.',
    textSection2_4d:'Jak więc wyglądają zajęcia?',
    textSection2_4e:'Prawdzimy dyskusje na zadane tematy, przygotowane lub nie',
    textSection2_4f: 'Rozmawiamy spontanicznie zgodnie z pojawiającymi się wątkami',
    textSection2_4g: 'Omawiamy to, co jest w danej chwili potrzebne',
    textSection2_4h: 'Gramatykę poruszamy tylko po to, aby wyeliminować pojawiające się błędy',
