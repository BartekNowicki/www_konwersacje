...
const data = {
    ...
    textSection2_1e: 'Zainteresowanych tą metodą odsyłam do lektury poniższej pozycji, napisanej przez samego twórcę tego podejścia.',
    textSection2_2a: 'No Polglish',
    textSection2_2b: 'przy szczególnej uwadze poświęconej eliminacji tzw. Polglish czyli interferencji języka polskiego podczas uczenia się i posługiwania się językiem obcym. Przykładem Polglish może być dość powszechny wśród Polaków zwrot "so, how to say this?" zamiast "so, how do you say it?" ',
    textSection2_3a: 'Growth Oriented',
    textSection2_3b: 'Growth Oriented explanation z każdego spotkania wyniesiesz nową dawkę wiedzy oraz zestaw fraz  do przećwiczenia i zapamiętania',
    textSection2_4a: 'discussion first',
    textSection2_4b: 'discussion explanation',
    textSection2_5a: 'IT assisted',
    textSection2_5b: 'nauka wspomagana progamistycznie (gry, baza danych fraz, konto ucznia, możliwość sprawdzania wiedzy poprzez testy online)',
    textSection2_6a: 'max 5',
    textSection2_4b: 'max 5 explanation',
